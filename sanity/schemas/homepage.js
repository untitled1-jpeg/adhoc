export default {
    ...
    fields: [
        ...
        },
        {
            ...
            group: 'contact',
            fieldset: 'contact',
            initialValue: 'Preferred method of communication',
        },
        {
            name: 'howDidYouHearLabel',
            title: 'Referral Field Label',
            type: 'string',
            group: 'contact',
            fieldset: 'contact',
        ...
        {
            name: 'howDidYouHearHint',
            title: 'Referral Field Hint',
            type: 'string',
            group: 'contact',
            fieldset: 'contact',
            description: 'Hint text for the Referral field (e.g. "Referral, Social Media, etc.")',
        },
    ],
    fieldsets: [
